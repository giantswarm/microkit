...
type Service interface {
	// Set stores the given value under the given key. It overrides the
	// value or creates a new one if id did not exist. Keys and values
	...
	// case the service using the storage wants to store its data as JSON
	// strings.
